...
<img src="/images/blog/high-protein-foods.webp" alt="High protein low calorie foods" width="1600" height="893" />
...
<div class="grid md:grid-cols-2 gap-4">
  ...
  <a href="/blog/macro-calculator-guide" class="block p-4 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
    ...
    <p class="text-sm text-gray-600 dark:text-gray-400 mb-0">Find your optimal protein, carbs, and fat</p>
  </a>
</div>
